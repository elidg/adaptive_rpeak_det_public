...
#if HIGH_FREQ==1
int16_t B1[] = B1_STRUCTURING_ELEMENT;
#endif

//																		SIZE IN BYTES PER LEAD
//										 								(250 Hz)		(500 Hz)
int16_t bufferEB0[CHANNELS][TAMB0];					//		100				200
int16_t bufferDB0[CHANNELS][TAMB0];					//		100				200
int16_t bufferDBc[CHANNELS][TAMBc];					//		150				300
int16_t bufferEBc[CHANNELS][TAMBc];					//		150				300
int16_t bufferEnt[CHANNELS][TAMBEnt];					//		300				600
#if HIGH_FREQ==1
volatile int16_t bufferFBc1[CHANNELS][TAMBFB];			//		10				18
volatile int16_t bufferFBc1ed[CHANNELS][TAMBFB];		//		10				18
volatile int16_t bufferFBc1de[CHANNELS][TAMBFB];		//		10				18
#endif

int16_t bufferEntrada[CHANNELS][BUFFER_SIZE_FILTER];	//		2				2
int16_t bufferSalida[CHANNELS][BUFFER_SIZE_FILTER];	//		2				2
//volatile int16_t bufferSalida[CHANNELS];

int16_t samplesRead[CHANNELS];							//		2		 		2
int16_t actEntrada[CHANNELS];							//		2				2
int16_t contador[CHANNELS];							//		2				2
int16_t aBEB0[CHANNELS];								//		2				2
int16_t pMinEB0[CHANNELS];								//		2				2
int16_t p2MinEB0[CHANNELS];							//		2				2
int16_t aBDB0[CHANNELS];								//		2				2
int16_t pMaxDB0[CHANNELS];								//		2				2
int16_t p2MaxDB0[CHANNELS];							//		2				2
int16_t aBDBc[CHANNELS];								//		2				2
int16_t pMaxDBc[CHANNELS];								//		2				2
int16_t p2MaxDBc[CHANNELS];							//		2				2
int16_t aBEBc[CHANNELS];								//		2				2
int16_t pMinEBc[CHANNELS];								//		2				2
int16_t p2MinEBc[CHANNELS];							//		2				2
int16_t aBEnt[CHANNELS];								//		2				2
int16_t rBEnt[CHANNELS];								//		2				2

#if HIGH_FREQ==1
volatile int16_t aBFBc1[CHANNELS];						//		2				2
volatile int16_t aFBc1x[CHANNELS];						//		2				2
volatile int16_t pMaxFBc1ed[CHANNELS];					//		2				2
volatile int16_t pMinFBc1de[CHANNELS];					//		2				2
volatile int16_t p2MinFBc1de[CHANNELS];				//		2				2
volatile int16_t p2MaxFBc1ed[CHANNELS];				//		2				2
volatile int16_t indiceB1[CHANNELS];					//		2				2
volatile int16_t min1E[CHANNELS];						//		2				2
volatile int16_t max1D[CHANNELS];						//		2				2
#endif

int16_t vaux[CHANNELS];								//		2				2
int16_t v2aux[CHANNELS];								//		2				2
